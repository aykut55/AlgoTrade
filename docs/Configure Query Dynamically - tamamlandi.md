...
- Query iki sekilde konfigure edilebilsin:
  ...
  2. Dosyadan (`inputs/configs/QueryConfig.txt`)
...
- [x] Asama 3: Query config dosyasi parser'ini ekleme (`QueryConfigLoader`) ve `inputs/configs/QueryConfig.txt` olusturma. (yapildi)
...
- [x] Asama 7: Derleme dogrulamasi ve kalan compile/runtime sorunlarini temizleme. (yapildi - `dotnet build` 0 hata)
