...
>>"main.py" echo.
>>"main.py" echo import dearpygui.dearpygui as dpg
>>"main.py" echo.
>>"main.py" echo.
...
>>"main.py" echo                 pass
>>"main.py" echo.
>>"main.py" echo         dpg.create_context()
>>"main.py" echo         dpg.create_viewport(title="DearPyGuiDataPlotter", width=800, height=600)
>>"main.py" echo.
>>"main.py" echo         with dpg.window(label="Ana Pencere", tag="main_window"):
>>"main.py" echo             dpg.add_text("Hello World")
>>"main.py" echo.
>>"main.py" echo         dpg.set_primary_window("main_window", True)
>>"main.py" echo.
>>"main.py" echo     def run(self):
>>"main.py" echo         subprocess.call("cls", shell=True)
>>"main.py" echo         dpg.setup_dearpygui()
>>"main.py" echo         dpg.show_viewport()
>>"main.py" echo         try:
>>"main.py" echo             dpg.start_dearpygui()
>>"main.py" echo         finally:
>>"main.py" echo             dpg.destroy_context()
>>"main.py" echo.
>>"main.py" echo.
