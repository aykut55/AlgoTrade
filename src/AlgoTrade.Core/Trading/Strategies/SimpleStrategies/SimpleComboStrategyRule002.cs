...
namespace AlgoTrade.Core.Trading.Strategies
{
    ...
    /// (2026-08-27 karari) - buy/sell ve takeProfit/stopLoss icin BAGIMSIZ (asymmetric) dispatch
    /// parametreleri. buySignalModeIndex/sellSignalModeIndex AKTIF (0: siralama/seviye, 1: kesisim -
    /// MA siralamasi+RSI momentum kosulunun TAMAMI icin, buy ve sell zamanlamasi AYRI AYRI secilir),
    /// digerleri PLACEHOLDER.
    ///
    ...
    public class SimpleComboStrategyRule002 : BaseStrategy
    {
        ...
        // buySignalModeIndex/sellSignalModeIndex'e gore uygulanir. RSI[i-3] > RSI[i-1] (RSI o aralikta DUSMUS, "sogumus
